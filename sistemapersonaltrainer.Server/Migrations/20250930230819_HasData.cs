    ...
    public partial class HasData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Adductor Magnus", "Adductor Magnus" },
                    { 2, "Anterior Deltoids", "Anterior Deltoids" },
                    { 3, "Biceps Brachii", "Biceps Brachii" },
                    { 4, "Biceps Femoris", "Biceps Femoris" },
                    { 5, "Brachialis", "Brachialis" },
                    { 6, "Brachioradialis", "Brachioradialis" },
                    { 7, "Erector Spinae", "Erector Spinae" },
                    { 8, "Extensor Hallucis Longus", "Extensor Hallucis Longus" },
                    { 9, "Flexor Carpi Radialis", "Flexor Carpi Radialis" },
                    { 10, "Gastrocnemius", "Gastrocnemius" },
                    { 11, "Gluteus Maximus", "Gluteus Maximus" },
                    { 12, "Gluteus Medius", "Gluteus Medius" },
                    { 13, "Gluteus Minimus", "Gluteus Minimus" },
                    { 14, "Iliopsoas", "Iliopsoas" },
                    { 15, "Latissimus Dorsi", "Latissimus Dorsi" },
                    { 16, "Obliques", "Obliques" },
                    { 17, "Pectoralis Major", "Pectoralis Major" },
                    { 18, "Posterior Deltoids", "Posterior Deltoids" },
                    { 19, "Quadriceps Femoris", "Quadriceps Femoris" },
                    { 20, "Rectus Abdominis", "Rectus Abdominis" },
                    { 21, "Rectus Femoris", "Rectus Femoris" },
                    { 22, "Rhomboids", "Rhomboids" },
                    { 23, "Serratus Anterior", "Serratus Anterior" },
                    { 24, "Soleus", "Soleus" },
                    { 25, "Tensor Fasciae Latae", "Tensor Fasciae Latae" },
                    { 26, "Teres Major", "Teres Major" },
                    { 27, "Teres Minor", "Teres Minor" },
                    { 28, "Tibialis Anterior", "Tibialis Anterior" },
                    { 29, "Tibialis Posterior", "Tibialis Posterior" },
                    { 30, "Transverse Abdominis", "Transverse Abdominis" },
                    { 31, "Trapezius", "Trapezius" },
                    { 32, "Triceps Brachii", "Triceps Brachii" },
                    { 33, "Upper Trapezius", "Upper Trapezius" },
                    { 34, "Lateral Deltoids", "Lateral Deltoids" },
                    { 35, "Anconeus", "Anconeus" },
                    { 36, "Infraspinatus", "Infraspinatus" },
                    { 37, "Levator Scapulae", "Levator Scapulae" },
                    { 38, "Extensor Digitorum Longus", "Extensor Digitorum Longus" },
                    { 39, "Supraspinatus", "Supraspinatus" },
                    { 40, "Medial Deltoids", "Medial Deltoids" },
                    { 41, "Subscapularis", "Subscapularis" },
                    { 42, "Vastus Mediais", "Vastus Mediais" }
                });
